...
class AppSettingsModel {
  ...
  factory AppSettingsModel.fromRow(Map<String, Object?> row) {
    ...
    return AppSettingsModel(
      AppSettings(
        ...
        autoLockDuration: lockSeconds == null
            ? null
  ...
  Map<String, Object?> toRow() => {
    ...
    'biometrics_enabled': RowConverters.boolToSql(entity.biometricsEnabled),
    'auto_lock_duration_seconds': entity.autoLockDuration?.inSeconds,
    'onboarding_completed': RowConverters.boolToSql(entity.onboardingCompleted),
